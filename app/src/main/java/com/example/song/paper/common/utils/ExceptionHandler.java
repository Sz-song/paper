...
public class ExceptionHandler {
    ...
    public static ResponeThrowable handleException(Throwable e) {
        // Toast.makeText(MyApplication.getContext(),"错误信息是"+e.getMessage(),Toast.LENGTH_SHORT).show();
        ResponeThrowable ex;
    ...
    public static class ResponeThrowable extends Exception {
        ...
        public ResponeThrowable(Throwable throwable, int status) {
            super(throwable);
            this.status = status;
    ...
    public static class ServerException extends RuntimeException {
        ...
        public ServerException(int status,String message){
            super(message);
            L.e("server exception is "+status+"  message  "+message);
            this.status = status;
        }
    }
